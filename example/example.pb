...
key	š *€
POST /api/admin/{key}/subscribeÜ
...
DataPayload*„
!PUT /api/admin/{key}/restrictionsÞ
...
RestApi{queryTime<:string}š *ô
#GET /api/admin/{key}/creation-timesÌ
...
KeysB/api*ê
!GET /api/admin/{key}/restrictionsÄ
...
!POST /api/admin/{key}/unsubscribeã
...
JSONSchemaB
json"schemašgBR
docK"IDataSetPayload is JSON payload on REST API request to create new data set2Œ
Times‚0

Data"
	šY
...

Data	šmBG
doc@">DataPayload is JSON payload on REST API request to update data2œ
Subscription‹;

URLB
json"urlšD
...

	StartTime	š:BJ
docC"AData holds JSON data valid from StartTime created at CreationTime2ª
